...
from DeadlineTech.utils.database import is_on_off, get_assistant
...
import logging
import aiohttp
from DeadlineTech import LOGGER
...
async def load_api_url():
    global YOUR_API_URL
    logger = LOGGER("DeadlineTech.platforms.Youtube.py")
    
    try:
        async with aiohttp.ClientSession() as session:
            async with session.get("https://batbin.me/messuages") as response:
